            ...
            <div class="top5-left">
                ...
                <div v-if="tableData.length>0">
                    <el-table :data="tableData" border style="width: 100%" :row-class-name="tableRowClassName">
                        ...
                        <el-table-column prop="sale_total_money" label="销售额(元)">
                        </el-table-column>
                    </el-table>
                </div>
            ...
            <div class="top5-center">
                <div class="top5-center-top top5-center-top-margin">
                    <div class="top5-center-top-ring">
                        <div>
                            <div class="top5-center-title"><span>成交比例</span><el-popover class="popover-item" width="240" trigger="hover"
                                content="成交比例=下单人数/支付人数">
                                <i slot="reference" class="el-icon-question"></i>
                            </el-popover></div>
                            <div>
                                <div class="top5-center-tip">支付人数</div>
                            </div>
                        </div>
                    ...
                    <div class="top5-center-num theme-color-6">{{orderFinish.order_user}}人</div>
                </div>
                <div class="top5-center-top">
                    <div class="top5-center-top-ring">
                        <div>
                            <div class="top5-center-title"><span>支付比例</span><el-popover class="popover-item" width="240" trigger="hover"
