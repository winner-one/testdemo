...
(1, 'shopro', 'basic', '商城信息', '', 'array', '{\"name\":\"Shopro\",\"domain\":\"http:\\/\\/shopro.7wpp.com\",\"version\":\"1.0.7\",\"logo\":\"http:\\/\\/api.7wpp.com\\/uploads\\/20200410\\/d5b2c163e9a23d78c7205d9ab5d7e47c.png\",\"copyright\":[\"\\u661f\\u54c1\\u79d1\\u6280Shopro\\u7248\\u6743\\u6240\\u6709\",\"Copyright 2018-2020\"]}', '', '', ''),
...
CREATE TABLE IF NOT EXISTS `__PREFIX__shopro_order` (
  ...
  `deletetime` int(11) DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `__PREFIX__shopro_order_order_sn_uindex` (`order_sn`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `__PREFIX__shopro_order_action` (
  ...
  `oper_type` enum('user','admin','system') NOT NULL COMMENT '操作人类型',
...
CREATE TABLE IF NOT EXISTS `__PREFIX__shopro_order_item` (
  ...
  `aftersale_status` tinyint(2) NOT NULL COMMENT '售后状态:0=未申请,1=申请售后,2=售后完成',
...
CREATE TABLE IF NOT EXISTS `__PREFIX__shopro_order_aftersale` (
  ...
  `deletetime` int(11) DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `__PREFIX__shopro_order_aftersale_sn_uindex` (`aftersale_sn`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `__PREFIX__shopro_verify` (
  ...
  `updatetime` int(11) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `__PREFIX__shopro_order_code_uindex` (`code`) USING BTREE COMMENT '核销码'
