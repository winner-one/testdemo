...
const ENV_API_URL = {
	...
	development:'http://www.testdemo.com/addons/shopro/',
	production:'http://www.testdemo.com/addons/shopro',
}
const ENV_BASE_URL = {
	// development: 'https://api.7wpp.com', //开发环境
	// production: 'https://api.7wpp.com', //生产环境
	development:'http://www.testdemo.com',
	production:'http://www.testdemo.com',
}
