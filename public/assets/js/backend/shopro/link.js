            ...
            var linkSelect = new Vue({
                ...
                methods: {
                        ...
                        switch (type) {
                            ...
                            case 'select':
                                if (that.multiple == 'true') {
                                    ...
                                    this.linkData[index].children[idx].selected = !this.linkData[index].children[idx].selected;
                                    // console.log(this.linkData[index].children[idx])
                                    this.rowData = rows;
                                    ...
                                    switch (row.path) {
                                        ...
                                        case '/pages/goods/detail/index':
                                            Fast.api.open("shopro/goods/goods/select?multiple=" + false, __('Choose'), {
                                                callback: function (data) {
                    ...
                    posterGood() {
                        ...
                        let row = that.rowData;
                        that.dialogVisible = false;
                        Fast.api.open("shopro/goods/goods/select", __('Choose'), {
                            callback: function (data) {
                                row.path_name = '商品海报'
